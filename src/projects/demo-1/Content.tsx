...
export default function Content() {
  return (
    <motion.article variants={container} initial="hidden" animate="show"
      ...
      <motion.h2 variants={item} className="text-2xl sm:text-3xl font-semibold">Portal Demo 1</motion.h2>
      <motion.p variants={item} className="opacity-80">This is the first placeholder demo project.</motion.p>
    </motion.article>
  )
}
